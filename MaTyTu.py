...
from PyQt5.QtWidgets import (QApplication, QComboBox, QDialog,QAction,
QDialogButtonBox, QFormLayout, QGridLayout, QGroupBox, QHBoxLayout,
QLabel, QLineEdit,QStyleFactory, QMenu, QMenuBar, QPushButton,QButtonGroup,
QVBoxLayout,QLineEdit,QFontDialog,QMessageBox,QCheckBox,QWidget,QMainWindow,
...
#       Window.tools_in_home(self)
    ...
    def load_matytu(self):
        ...
        # extractAction = QAction('Level1', self)
    ...
    def level1(self):
        self.filename = 'level1.txt'
        self.load_words()
        qmsgBox =  QMessageBox.about(self, 'Level Select',"<P><font size = 6><b>पातळी १ निवडली आहे.</b>"  )
        self.get_word()
    ...
    def level2(self):
        ...
        self.load_words()
        qmsgBox =  QMessageBox.about(self, 'Level Select',"<P><font size = 6><b>पातळी २ निवडली आहे.</b>"  )
        self.get_word()
    ...
    def level3(self):
        ...
        self.load_words()
        qmsgBox =  QMessageBox.about(self, 'Level Select',"<P><font size = 6><b>पातळी ३ निवडली आहे.</b>"  )
        self.get_word()
        print("Words from '"+self.filename +"' loaded successfully")
    def level4(self):
        ...
        self.load_words()
        qmsgBox =  QMessageBox.about(self, 'Level Select',"<P><font size = 6><b>पातळी ४ निवडली आहे.</b>"  )
        self.get_word()
        print("Words from '"+self.filename +"' loaded successfully")
    def level5(self):
        ...
        self.load_words()
        qmsgBox =  QMessageBox.about(self, 'Level Select',"<P><font size = 6><b>पातळी ५ निवडली आहे.</b>"  )
        self.get_word()
        print("Words from '"+self.filename +"' loaded successfully")
    ...
    def close_application(self):
        choice = QMessageBox.question(self,'MaTyTu' , 
          "<P><font size = 6><b>मटायट्यु <FONT COLOR='#800000'>बंद</FONT> करा ?</b> ",QMessageBox.Yes | QMessageBox.No)
        # QMessageBox.setFont(button_font)
...
def run():
    ...
    # print(app.keyboardInputLocale().language())
    GUI = Window()
    sys.exit(app.exec_())
